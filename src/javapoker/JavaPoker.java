...
public class JavaPoker {
    ...
    public JavaPoker() throws IOException {
        ...
        JLabel playercard2 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        playercard2.setBounds(925, 850, 200, 300);

        JLabel droidcard1 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        droidcard1.setBounds(800, -100, 200, 300);
        JLabel droidcard2 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        droidcard2.setBounds(925, -100, 200, 300);

        JLabel c3pocard1 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        c3pocard1.setBounds(10, 350, 200, 300);
        JLabel c3pocard2 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        c3pocard2.setBounds(50, 350, 200, 300);

        JLabel vadercard1 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        vadercard1.setBounds(1650, 350, 200, 300);
        JLabel vadercard2 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        vadercard2.setBounds(1705, 350, 200, 300);

        JLabel riverCard1 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        riverCard1.setBounds(350, 350, 200, 300);
        JLabel riverCard2 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        riverCard2.setBounds(600, 350, 200, 300);
        JLabel riverCard3 = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        riverCard3.setBounds(850, 350, 200, 300);

        JLabel turnCard = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        turnCard.setBounds(1100, 350, 200, 300);

        JLabel flopCard = new JLabel(new ImageIcon(table.deck.getCard().getCardImage()));
        ...
        String moneyAmount = "1500";
        JLabel amountofMoney = new JLabel(moneyAmount);
        ...
        pane.add(amountofMoney);
         ...
         MouseListener ml1 = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                int value = Integer.parseInt(moneyAmount);
                ...
                if (SwingUtilities.isRightMouseButton(e)) {
                   ...
                   value--;
                   String backtoInt = String.valueOf(value);
