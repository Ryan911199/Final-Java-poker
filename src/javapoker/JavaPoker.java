...
public class JavaPoker {
    ...
    public JavaPoker() throws IOException {
        ...
        JLabel droidcard1 = new JLabel(new ImageIcon(table.botOne.hand[0].getCardImage()));
        droidcard1.setBounds(800, -100, 200, 300);
        JLabel droidcard2 = new JLabel(new ImageIcon(table.botOne.hand[1].getCardImage()));
        droidcard2.setBounds(925, -100, 200, 300);
        JLabel c3pocard1 = new JLabel(new ImageIcon(table.botTwo.hand[0].getCardImage()));
        c3pocard1.setBounds(10, 350, 200, 300);
        JLabel c3pocard2 = new JLabel(new ImageIcon(table.botTwo.hand[1].getCardImage()));
